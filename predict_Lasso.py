...
print('Here, we predict age in the test data sets, based on Lasso models trained on cortical volume, thickness and surface are extracted from FS5 and FS7.')
...
#FS5_model = pickle.load('/Users/max/Documents/Projects/FS_brainage/FS5/results/Lasso_model.pkl')
#FS7_model = pickle.load('/Users/max/Documents/Projects/FS_brainage/FS7/results/Lasso_model.pkl')
...
# now, save the df
df1.to_csv('/Users/max/Documents/Projects/FS_brainage/FS5predictions_Lasso.csv', index=False)  
df2.to_csv('/Users/max/Documents/Projects/FS_brainage/FS7predictions_Lasso.csv', index=False)  
print("All done.")